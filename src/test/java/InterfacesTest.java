...
public class InterfacesTest {
    ...
    @Test
    public void test_0_circle_methods() {
    ...
    @Test
    public void test_1_square_methods() {
    ...
    @Test
    public void test_2_rectangle_methods() {
    ...
    @Test
    public void test_4_totalPerimeter() {
        Circle a = new Circle(5.0);
        Square b = new Square(8);
        Rectangle c = new Rectangle(2,5);
    ...
    @Test
    public void test_5_inheritance() throws Exception {
    ...
    @Test
    public void test_6_manager_accepts_other_figures() throws Exception {
